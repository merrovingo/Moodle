...
# Esta diseñado para funcionar con Debian 9 x86, x86_64
...
script_moodle () {
	...
	sleep 3
	cd /var/www/$CURSO
	git clone --depth=1 -b $RAMA_MOODLE --single-branch git://git.moodle.org/moodle.git
...
script_php () {
	...
	sleep 3
	apt-get install -y \
	php-pear php7.0 php7.0-mysql php7.0-curl php7.0-gd php7.0-gmp \
	php7.0-intl php7.0-mcrypt php7.0-xsl php7.0-xmlrpc mcrypt libgd-tools
